...
while not rospy.is_shutdown():
    ...
    if (jogCtrl == 0  ):
        ...
        if((mode_aev ==1 and score_detection <= detectionValueCtrl and markers_object_ctrl == 1) or
            (mode_aev ==1 and score_detection <= 5 and markers_object_ctrl == 0) or
            (mode_aev ==1 and abs(score_reliability) >= (reliabilityValueCtrl)) or 
            brake_req == 1):
    ...
    print(mode_aev,reliabilityValueCtrl,detectionValueCtrl,speedValueCtrl)